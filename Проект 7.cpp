...
#define TRUEORFALSE(vvedenoe_chislo, konechnoe_chislo) ((vvedenoe_chislo >= 0 && vvedenoe_chislo < konechnoe_chislo)) //dz2 вставка
...
int main()
{
...

    {
        ...
        */
        ...
        cout << "Размер файла: " << sizeof(SOTRUDNIK) << " bytes" << endl; //выводим размер "коленжанки"
